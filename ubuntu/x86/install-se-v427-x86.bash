...
sleep 2
wget -O softether-vpn-4-27-x86.tar.gz http://softether-download.com/files/softether/v4.27-9667-beta-2018.05.26-tree/Linux/SoftEther_VPN_Server/32bit_-_Intel_x86/softether-vpnserver-v4.27-9667-beta-2018.05.26-linux-x86-32bit.tar.gz
tar -xzf softether-vpn-4-27-x86.tar.gz
cd vpnserver
